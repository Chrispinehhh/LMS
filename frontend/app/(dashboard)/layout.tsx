...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900">
      {/* Sidebar Navigation */}
      <aside className="w-64 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl text-gray-900 dark:text-white border-r border-gray-200 dark:border-gray-700 flex flex-col shadow-xl">
        {/* Logo */}
